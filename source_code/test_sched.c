...
void set_process_bjf(int pid, int priority_ratio, int arrival_time_ratio, 
...
void set_system_bjf(int priority_ratio, int arrival_time_ratio, 
                    int executed_cycle_ratio, int process_size_ratio)
{
    if (priority_ratio < 0 || arrival_time_ratio < 0 || executed_cycle_ratio < 0 || process_size_ratio < 0)
    {
...
int main(int argc, char* argv[])
{
    ...
    //         exit();
    //     }
    //     set_priority_bjf(atoi(argv[2]), atoi(argv[3]), atoi(argv[4]));
    // }
    else
        help();
    exit();
